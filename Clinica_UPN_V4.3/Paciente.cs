...
public partial class Paciente
{
    ...
    [StringLength(10, MinimumLength = 10, ErrorMessage = "El Usuario debe tener exactamente 10 caracteres.")]
    ...
    public string UsuarioPac { get; set; } = null!;

    [Required(ErrorMessage = "El campo Contraseña es obligatorio.")]
    [StringLength(30, MinimumLength = 10, ErrorMessage = "La Contraseña debe tener minímo 10 caracteres o más.")]
    [ValidarContraseña(ErrorMessage = "La Contraseña debe contener al menos una letra mayúscula y al menos un número.")]
    ...
    public string NombreCompleto => $"{Dni} - {Nombres} {Apellidos}";
...
public class ValidarContraseñaAttribute : ValidationAttribute
{
